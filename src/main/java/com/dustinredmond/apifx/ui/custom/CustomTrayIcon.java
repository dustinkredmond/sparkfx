...
public class CustomTrayIcon {
    ...
    public CustomTrayIcon(Stage parentStage, URL iconImagePath) {
    ...
    /**
     * Adds the CustomTrayIcon to the system tray.
     * This will add the TrayIcon with the image initialized in the
     * {@code CustomTrayIcon}'s constructor. By default, an empty popup
     * menu it shown
     */
    public void show() {
        SwingUtilities.invokeLater(() -> {
            try {
                ...
                // User will be able to override this by calling new CustomTrayIcon(...).addExitItem(false)
                if (addExitMenuItem) {
    ...
    /**
     * Adds a MenuItem to the {@code CustomTrayIcon} that will close the JavaFX application
     * and terminate the JVM. If this is not set to @{code true}, a developer will have
     * to implement this functionality themselves.
     * @param addExitMenuItem If true, the CustomTrayIcon's popup menu will display an option for
    ...
    /**
     * Removes the specified item from the CustomTrayIcon's menu. Does nothing
    ...
    /**
     * Adds the specified MenuItem to the CustomTrayIcon's menu
    ...
    /**
     * Sets the CustomTrayIcon's tooltip that is displayed on mouse hover.
    ...
    /**
     * Sets the application's title. This is used in the CustomTrayIcon where appropriate.
     */
    public void setApplicationTitle(String title) { this.appTitle = title; }

    /**
     * Removes the {@code CustomTrayIcon} from the system tray.
        ...
        if (!errors.isEmpty()) {
            throw new RuntimeException(String.format(
                    "The following methods were called on the " +
                            ...
                            "supported by CustomTrayIcon.", errors));
        }
